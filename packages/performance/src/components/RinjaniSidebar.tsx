...
function Frame6({ onCollapseToggle }: Frame6Props) {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[232px]">
      <div className="basis-0 content-stretch flex grow items-center justify-between min-h-px min-w-px relative shrink-0">
        ...
        <button 
          ...
          className="flex items-center justify-center relative shrink-0 hover:opacity-80 transition-opacity cursor-pointer p-1"
        >
          <div className="flex-none rotate-[180deg]">
            <IconParkOutlineExpandLeft />
          </div>
...
function Container() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative rounded-[8px] shrink-0 w-full" data-name="Container">
      <Perfomance />
      <p className="basis-0 font-['Inter:Semi_Bold',sans-serif] font-semibold grow leading-[24px] min-h-px min-w-px not-italic relative shrink-0 text-[16px] text-white whitespace-pre-wrap">{`Talent  Management System`}</p>
    </div>
  );
}
...
function Container4() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start not-italic relative shrink-0 text-[#fdfdfd] w-[167px]" data-name="Container">
      ...
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-full relative shrink-0 text-[14px] w-[min-content]">Profiling talent</p>
    </div>
  );
}
...
function Container3() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start not-italic relative shrink-0 text-[#fdfdfd] w-[167px]" data-name="Container">
      ...
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-full relative shrink-0 text-[14px] w-[min-content]">Based on Perfomance</p>
    </div>
  );
}
...
function Container1() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start not-italic relative shrink-0 text-[#fdfdfd] w-[167px]" data-name="Container">
      ...
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-full relative shrink-0 text-[14px] w-[min-content]">Longlist Employee</p>
    </div>
  );
}
...
function Container5() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start not-italic relative shrink-0 text-[#fdfdfd] w-[167px]" data-name="Container">
      ...
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-full relative shrink-0 text-[14px] w-[min-content]">For internal employee</p>
    </div>
  );
}
...
function ContainerEA() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start not-italic relative shrink-0 text-[#fdfdfd] w-[167px]" data-name="Container">
      ...
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-full relative shrink-0 text-[14px] w-[min-content]">Cost & Strategy</p>
    </div>
  );
}
...
function ContainerCA() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start not-italic relative shrink-0 text-[#fdfdfd] w-[167px]" data-name="Container">
      ...
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[20px] min-w-full relative shrink-0 text-[14px] w-[min-content]">Career Path</p>
    </div>
  );
}
...
function Frame3({ onBackClick, onCollapseToggle, onProfileClick, profileButtonRef }: Frame3Props) {
  return (
    <div className="basis-0 box-border content-stretch flex flex-col gap-[24px] grow items-start min-h-px min-w-px overflow-clip pb-[16px] pt-[12px] px-[16px] relative shrink-0 z-10">
      <Frame6 onCollapseToggle={onCollapseToggle} />
