...
import { Search, Filter, AlertCircle, Calendar, Users, FileText } from 'lucide-react';
import { eligibleEmployees, periodicReviewCategories, getEligibleEmployees } from '../data/mockTalentReviewData';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="p-4 rounded" style={{ backgroundColor: 'var(--color-card)', border: '1px solid var(--color-border)' }}>
            <div className="flex items-center justify-between">
              <div>
                ...
                <p style={{ fontSize: 'var(--text-2xl)', fontWeight: 'var(--font-weight-semibold)', color: 'var(--color-destructive)' }}>
                  {positionTenure3y}
                </p>
              </div>
              <AlertCircle className="w-8 h-8" style={{ color: 'var(--color-destructive)' }} />
            </div>
          </div>
          ...
          <div className="p-4 rounded" style={{ backgroundColor: 'var(--color-card)', border: '1px solid var(--color-border)' }}>
            <div className="flex items-center justify-between">
              ...
              <Calendar className="w-8 h-8" style={{ color: 'var(--color-destructive)' }} />
            </div>
          </div>
        </div>
