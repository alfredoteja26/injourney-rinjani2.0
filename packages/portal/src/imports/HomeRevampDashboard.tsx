import svgPaths from "./svg-qjs9o2sd12";
import clsx from "clsx";
import imgImage296 from "figma:asset/c431b6a1465f2d5e74a13b698b185dc831318ab2.png";
...
import imgButton from "figma:asset/a812b51f247759df2c1c5305e12b9e322bfae464.png";
import { EQSDetailModal } from "../components/EQSDetailModal";
...
type BackgroundImage35Props = {
  additionalClassNames?: string;
};

function BackgroundImage35({ children, additionalClassNames = "" }: React.PropsWithChildren<BackgroundImage35Props>) {
  return (
...
function BackgroundImage34({ children }: React.PropsWithChildren<{}>) {
  return (
...
function BackgroundImage33({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="relative shrink-0 w-full">
...
function BackgroundImage32({ children }: React.PropsWithChildren<{}>) {
  return (
...
type BackgroundImage31Props = {
  additionalClassNames?: string;
};

function BackgroundImage31({ children, additionalClassNames = "" }: React.PropsWithChildren<BackgroundImage31Props>) {
  return (
...
type BackgroundImage26Props = {
  additionalClassNames?: string;
};

function BackgroundImage26({ children, additionalClassNames = "" }: React.PropsWithChildren<BackgroundImage26Props>) {
  return (
...
type BackgroundImage25Props = {
  additionalClassNames?: string;
};

function BackgroundImage25({ children, additionalClassNames = "" }: React.PropsWithChildren<BackgroundImage25Props>) {
  return <BackgroundImage26 additionalClassNames={clsx("size-[16px]", additionalClassNames)}>{children}</BackgroundImage26>;
}

function BackgroundImage24({ children }: React.PropsWithChildren<{}>) {
  return (
...
function BackgroundImage20({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="basis-0 bg-white grow min-h-px min-w-px relative rounded-[16px] shrink-0">
      ...
      <BackgroundImage21>{children}</BackgroundImage21>
    </div>
  );
}
...
function TabBackgroundImage({ children }: React.PropsWithChildren<{}>) {
  return (
    <div className="basis-0 bg-white grow min-h-px min-w-px relative shadow-[0px_2px_4px_0px_rgba(217,217,217,0.2)] shrink-0">
      <BackgroundImage23>{children}</BackgroundImage23>
    </div>
  );
}
  ...
  return (
    <div className="relative shrink-0 w-full">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center p-[8px] relative w-full">{children}</div>
      </div>
    </div>
  );
}
...
function BackgroundImage16({ children, additionalClassNames = "" }: React.PropsWithChildren<BackgroundImage16Props>) {
  return (
    <BackgroundImage26 additionalClassNames={additionalClassNames}>
      <g id="Icon">{children}</g>
    </BackgroundImage26>
  );
}
...
function IconBackgroundImage2({ additionalClassNames = "" }: IconBackgroundImage2Props) {
  return (
    <BackgroundImage16 additionalClassNames={clsx("absolute size-[16px] top-[2px]", additionalClassNames)}>
...
function ParagraphBackgroundImageAndText5({ text }: ParagraphBackgroundImageAndText5Props) {
  return <BackgroundImage27>{text}</BackgroundImage27>;
}
...
function IconBackgroundImage1({ additionalClassNames = "" }: IconBackgroundImage1Props) {
  return (
    <BackgroundImage16 additionalClassNames={clsx("size-[16px]", additionalClassNames)}>
...
function BackgroundImage15({ text, text1 }: BackgroundImage15Props) {
  return (
    <BackgroundImage17>
...
function BackgroundImage14({ text, text1, text2, text3 }: BackgroundImage14Props) {
  return (
    <BackgroundImage17>
...
function IconBackgroundImage() {
  return (
    <BackgroundImage16 additionalClassNames="relative shrink-0 size-[16px]">
...
function ParagraphBackgroundImageAndText2({ text }: ParagraphBackgroundImageAndText2Props) {
  return <BackgroundImage29>{text}</BackgroundImage29>;
}
...
function HeadingBackgroundImageAndText1({ text }: HeadingBackgroundImageAndText1Props) {
  return <BackgroundImage30>{text}</BackgroundImage30>;
}
...
function BackgroundImage12({ text, text1, text2 }: BackgroundImage12Props) {
  return (
...
function BackgroundImage10() {
  return (
    <div className="[grid-area:1_/_1] flex items-center justify-center ml-[66.18%] mt-[49.28%] relative size-[22.993px]">
      <div className="flex-none scale-y-[-100%] size-[22.993px]">
        <BackgroundImage18>
          <g id="Clip path group">
            <path d={svgPaths.p302b0d00} id="path165" stroke="url(#paint0_linear_3_7209)" strokeMiterlimit="10" strokeOpacity="0.08" strokeWidth="1.10267" />
          </g>
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_7209" x1="12.0489" x2="12.0489" y1="0.552482" y2="23.5451">
...
function BackgroundImage9() {
  return (
    <div className="[grid-area:1_/_1] flex items-center justify-center ml-[16.23%] mt-0 relative size-[22.993px]">
      <div className="flex-none scale-y-[-100%] size-[22.993px]">
        <BackgroundImage18>
          <g id="Clip path group">
            <path d={svgPaths.p11390000} id="path163" stroke="url(#paint0_linear_3_7092)" strokeMiterlimit="10" strokeOpacity="0.08" strokeWidth="1.10267" />
          </g>
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_7092" x1="12.0489" x2="12.0489" y1="0.552482" y2="23.5451">
              <stop stopColor="white" />
              <stop offset="1" stopColor="#00858A" />
            </linearGradient>
          </defs>
...
function BackgroundImage8() {
  return (
    <div className="[grid-area:1_/_1] flex items-center justify-center ml-[0.01%] mt-[50.04%] relative size-[22.987px]">
      <div className="flex-none scale-y-[-100%] size-[22.987px]">
        <BackgroundImage18>
          <g id="Clip path group">
            <path d={svgPaths.p332fae00} id="path155" stroke="url(#paint0_linear_3_7098)" strokeMiterlimit="10" strokeOpacity="0.08" strokeWidth="1.10267" />
          </g>
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_7098" x1="12.0447" x2="12.0447" y1="0.551333" y2="23.5379">
              <stop stopColor="white" />
              <stop offset="1" stopColor="#00858A" />
            </linearGradient>
          </defs>
...
function BackgroundImage7() {
  return (
    <div className="[grid-area:1_/_1] flex h-[22.993px] items-center justify-center ml-[66.18%] mt-[16.15%] relative w-[22.999px]">
      <div className="flex-none h-[22.993px] scale-y-[-100%] w-[22.999px]">
        <BackgroundImage18>
          <g id="Clip path group">
            <path d={svgPaths.pc522180} id="path167" stroke="url(#paint0_linear_3_7104)" strokeMiterlimit="10" strokeOpacity="0.08" strokeWidth="1.10267" />
          </g>
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_7104" x1="12.0507" x2="12.0507" y1="0.551333" y2="23.544">
              <stop stopColor="white" />
              <stop offset="1" stopColor="#00858A" />
            </linearGradient>
          </defs>
  ...
  return (
    <div className="[grid-area:1_/_1] flex items-center justify-center ml-[66.18%] mt-[49.28%] relative size-[22.993px]">
      <div className="flex-none scale-y-[-100%] size-[22.993px]">
        <BackgroundImage18>
          <g id="Clip path group">
            <path d={svgPaths.p302b0d00} id="path165" stroke="url(#paint0_linear_3_7107)" strokeMiterlimit="10" strokeOpacity="0.08" strokeWidth="1.10267" />
          </g>
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_7107" x1="12.0489" x2="12.0489" y1="0.552482" y2="23.5451">
              <stop stopColor="white" />
              <stop offset="1" stopColor="#00858A" />
            </linearGradient>
          </defs>
...
function BackgroundImage5() {
  return (
    <div className="[grid-area:1_/_1] flex items-center justify-center ml-[49.36%] mt-[0.01%] relative size-[22.993px]">
      <div className="flex-none scale-y-[-100%] size-[22.993px]">
        <BackgroundImage18>
          <g id="Clip path group">
            <path d={svgPaths.p4abf4f0} id="path161" stroke="url(#paint0_linear_3_7113)" strokeMiterlimit="10" strokeOpacity="0.08" strokeWidth="1.10267" />
          </g>
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_7113" x1="12.0477" x2="12.0477" y1="0.551334" y2="23.544">
              <stop stopColor="white" />
              <stop offset="1" stopColor="#00858A" />
            </linearGradient>
          </defs>
...
function BackgroundImage4() {
  return (
    <div className="[grid-area:1_/_1] flex items-center justify-center ml-0 mt-[16.91%] relative size-[22.993px]">
      <div className="flex-none scale-y-[-100%] size-[22.993px]">
        <BackgroundImage18>
          <g id="Clip path group">
            <path d={svgPaths.p3d6190f0} id="path153" stroke="url(#paint0_linear_3_7125)" strokeMiterlimit="10" strokeOpacity="0.08" strokeWidth="1.10267" />
          </g>
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_7125" x1="12.048" x2="12.048" y1="0.551333" y2="23.544">
              <stop stopColor="white" />
              <stop offset="1" stopColor="#00858A" />
            </linearGradient>
          </defs>
  ...
  return (
    <div className="[grid-area:1_/_1] flex items-center justify-center ml-[16.23%] mt-0 relative size-[22.993px]">
      <div className="flex-none scale-y-[-100%] size-[22.993px]">
        <BackgroundImage18>
          <g id="Clip path group">
            <path d={svgPaths.p11390000} id="path163" stroke="url(#paint0_linear_3_7136)" strokeMiterlimit="10" strokeOpacity="0.08" strokeWidth="1.10267" />
          </g>
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_7136" x1="12.0489" x2="12.0489" y1="0.552482" y2="23.5451">
              <stop stopColor="white" />
              <stop offset="1" stopColor="#00858A" />
            </linearGradient>
          </defs>
...
function BackgroundImage2() {
  return (
    <div className="[grid-area:1_/_1] flex h-[22.999px] items-center justify-center ml-[50.04%] mt-[66.18%] relative w-[22.993px]">
      <div className="flex-none h-[22.999px] scale-y-[-100%] w-[22.993px]">
        <BackgroundImage18>
          <g id="Clip path group">
            <path d={svgPaths.p1af10200} id="path159" stroke="url(#paint0_linear_3_7116)" strokeMiterlimit="10" strokeOpacity="0.08" strokeWidth="1.10267" />
          </g>
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_7116" x1="12.0477" x2="12.0477" y1="0.551333" y2="23.55">
              <stop stopColor="white" />
              <stop offset="1" stopColor="#00858A" />
            </linearGradient>
          </defs>
...
function BackgroundImage1() {
  return (
    <div className="[grid-area:1_/_1] flex items-center justify-center ml-[16.91%] mt-[66.19%] relative size-[22.993px]">
      <div className="flex-none scale-y-[-100%] size-[22.993px]">
        <BackgroundImage18>
          <g id="Clip path group">
            <path d={svgPaths.p15f39c00} id="path157" stroke="url(#paint0_linear_3_7153)" strokeMiterlimit="10" strokeOpacity="0.08" strokeWidth="1.10267" />
          </g>
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_7153" x1="12.0489" x2="12.0489" y1="0.551596" y2="23.5442">
              <stop stopColor="white" />
              <stop offset="1" stopColor="#00858A" />
            </linearGradient>
          </defs>
  ...
  return (
    <div className="[grid-area:1_/_1] flex items-center justify-center ml-[0.01%] mt-[50.04%] relative size-[22.987px]">
      <div className="flex-none scale-y-[-100%] size-[22.987px]">
        <BackgroundImage18>
          <g id="Clip path group">
            <path d={svgPaths.p332fae00} id="path155" stroke="url(#paint0_linear_3_7162)" strokeMiterlimit="10" strokeOpacity="0.08" strokeWidth="1.10267" />
          </g>
          <defs>
            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_7162" x1="12.0447" x2="12.0447" y1="0.551333" y2="23.5379">
              <stop stopColor="white" />
              <stop offset="1" stopColor="#00858A" />
            </linearGradient>
          </defs>
    ...
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
      <div className="[grid-area:1_/_1] flex items-center justify-center ml-0 mt-[16.91%] relative size-[22.993px]">
        <div className="flex-none scale-y-[-100%] size-[22.993px]">
          <BackgroundImage18>
            <g id="Clip path group">
              <path d={svgPaths.p3684a700} id="path153" stroke="url(#paint0_linear_3_7128)" strokeMiterlimit="10" strokeOpacity="0.08" strokeWidth="1.10267" />
            </g>
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_7128" x1="12.048" x2="12.048" y1="0.551333" y2="23.5447">
                <stop stopColor="white" />
                <stop offset="1" stopColor="#00858A" />
              </linearGradient>
            </defs>
      ...
      <div className="[grid-area:1_/_1] flex items-center justify-center ml-[0.01%] mt-[50.03%] relative size-[22.987px]">
        <div className="flex-none scale-y-[-100%] size-[22.987px]">
          <BackgroundImage18>
            <g id="Clip path group">
              <path d={svgPaths.p227f9a00} id="path155" stroke="url(#paint0_linear_3_7110)" strokeMiterlimit="10" strokeOpacity="0.08" strokeWidth="1.10267" />
            </g>
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_7110" x1="12.0447" x2="12.0447" y1="0.551333" y2="23.5387">
                <stop stopColor="white" />
                <stop offset="1" stopColor="#00858A" />
              </linearGradient>
            </defs>
      ...
      <div className="[grid-area:1_/_1] flex items-center justify-center ml-[16.91%] mt-[66.19%] relative size-[22.993px]">
        <div className="flex-none scale-y-[-100%] size-[22.993px]">
          <BackgroundImage18>
            <g id="Clip path group">
              <path d={svgPaths.p152adc80} id="path157" stroke="url(#paint0_linear_3_7089)" strokeMiterlimit="10" strokeOpacity="0.08" strokeWidth="1.10267" />
            </g>
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_7089" x1="12.0489" x2="12.0489" y1="0.551596" y2="23.545">
                <stop stopColor="white" />
                <stop offset="1" stopColor="#00858A" />
              </linearGradient>
            </defs>
      ...
      <div className="[grid-area:1_/_1] flex h-[22.999px] items-center justify-center ml-[50.04%] mt-[66.18%] relative w-[22.993px]">
        <div className="flex-none h-[22.999px] scale-y-[-100%] w-[22.993px]">
          <BackgroundImage18>
            <g id="Clip path group">
              <path d={svgPaths.p2cdc2300} id="path159" stroke="url(#paint0_linear_3_7086)" strokeMiterlimit="10" strokeOpacity="0.08" strokeWidth="1.10267" />
            </g>
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_7086" x1="12.0477" x2="12.0477" y1="0.551333" y2="23.5507">
                <stop stopColor="white" />
                <stop offset="1" stopColor="#00858A" />
              </linearGradient>
            </defs>
      ...
      <div className="[grid-area:1_/_1] flex items-center justify-center ml-[49.36%] mt-0 relative size-[22.993px]">
        <div className="flex-none scale-y-[-100%] size-[22.993px]">
          <BackgroundImage18>
            <g id="Clip path group">
              <path d={svgPaths.p20c31f00} id="path161" stroke="url(#paint0_linear_3_7171)" strokeMiterlimit="10" strokeOpacity="0.08" strokeWidth="1.10267" />
            </g>
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_7171" x1="12.0477" x2="12.0477" y1="0.551335" y2="23.5447">
                <stop stopColor="white" />
                <stop offset="1" stopColor="#00858A" />
              </linearGradient>
            </defs>
      ...
      <div className="[grid-area:1_/_1] flex items-center justify-center ml-[16.23%] mt-0 relative size-[22.993px]">
        <div className="flex-none scale-y-[-100%] size-[22.993px]">
          <BackgroundImage18>
            <g id="Clip path group">
              <path d={svgPaths.p2f6b2500} id="path163" stroke="url(#paint0_linear_3_7083)" strokeMiterlimit="10" strokeOpacity="0.08" strokeWidth="1.10267" />
            </g>
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_7083" x1="12.0489" x2="12.0489" y1="0.552482" y2="23.5459">
                <stop stopColor="white" />
                <stop offset="1" stopColor="#00858A" />
              </linearGradient>
            </defs>
      ...
      <div className="[grid-area:1_/_1] flex items-center justify-center ml-[66.18%] mt-[49.28%] relative size-[22.993px]">
        <div className="flex-none scale-y-[-100%] size-[22.993px]">
          <BackgroundImage18>
            <g id="Clip path group">
              <path d={svgPaths.p389d9200} id="path165" stroke="url(#paint0_linear_3_7075)" strokeMiterlimit="10" strokeOpacity="0.08" strokeWidth="1.10267" />
            </g>
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_7075" x1="12.0489" x2="12.0489" y1="0.552482" y2="23.5459">
                <stop stopColor="white" />
                <stop offset="1" stopColor="#00858A" />
              </linearGradient>
            </defs>
      ...
      <div className="[grid-area:1_/_1] flex h-[22.993px] items-center justify-center ml-[66.18%] mt-[16.15%] relative w-[22.999px]">
        <div className="flex-none h-[22.993px] scale-y-[-100%] w-[22.999px]">
          <BackgroundImage18>
            <g id="Clip path group">
              <path d={svgPaths.pb68b480} id="path167" stroke="url(#paint0_linear_3_7147)" strokeMiterlimit="10" strokeOpacity="0.08" strokeWidth="1.10267" />
            </g>
            <defs>
              <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_7147" x1="12.0507" x2="12.0507" y1="0.551333" y2="23.5447">
                <stop stopColor="white" />
                <stop offset="1" stopColor="#00858A" />
              </linearGradient>
            </defs>
...
export default function HomeRevampDashboard() {
  const [isEQSModalOpen, setIsEQSModalOpen] = useState(false);
  
  return (
    <div className="bg-[#006573] content-stretch flex flex-col items-start relative size-full" data-name="Home | Revamp Dashboard">
      <div className="basis-0 content-stretch flex grow items-start min-h-px min-w-px overflow-clip relative shrink-0 w-full">
        <div className="content-stretch flex flex-col h-[1024px] items-start overflow-clip shrink-0 sticky top-0" data-name="Sidebar Platforms">
          <div className="content-stretch flex flex-col h-[1024px] items-start overflow-x-clip overflow-y-auto relative shrink-0" data-name="Sidebar - Small">
            <div className="basis-0 bg-[#006573] content-stretch flex flex-col gap-[30px] grow items-start min-h-px min-w-px overflow-clip pb-[16px] pt-[12px] px-[16px] relative shrink-0">
              <div className="absolute content-stretch flex flex-col items-start justify-center leading-[0] left-0 overflow-clip top-0" data-name="Kawung Small">
                  ...
                  <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
                    <div className="[grid-area:1_/_1] flex items-center justify-center ml-0 mt-[16.91%] relative size-[22.993px]">
                      <div className="flex-none scale-y-[-100%] size-[22.993px]">
                        <BackgroundImage18>
                          <g id="Clip path group">
                            <path d={svgPaths.p3d6190f0} id="path153" stroke="url(#paint0_linear_3_7203)" strokeMiterlimit="10" strokeOpacity="0.08" strokeWidth="1.10267" />
                          </g>
                          <defs>
                            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_7203" x1="12.048" x2="12.048" y1="0.551333" y2="23.544">
                              <stop stopColor="white" />
                              <stop offset="1" stopColor="#00858A" />
                            </linearGradient>
                          </defs>
                    ...
                    <div className="[grid-area:1_/_1] flex items-center justify-center ml-[49.36%] mt-[0.01%] relative size-[22.993px]">
                      <div className="flex-none scale-y-[-100%] size-[22.993px]">
                        <BackgroundImage18>
                          <g id="Clip path group">
                            <path d={svgPaths.p4abf4f0} id="path161" stroke="url(#paint0_linear_3_7165)" strokeMiterlimit="10" strokeOpacity="0.08" strokeWidth="1.10267" />
                          </g>
                          <defs>
                            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_7165" x1="12.0477" x2="12.0477" y1="0.551334" y2="23.544">
                              <stop stopColor="white" />
                              <stop offset="1" stopColor="#00858A" />
                            </linearGradient>
                          </defs>
                    ...
                    <div className="[grid-area:1_/_1] flex items-center justify-center ml-[66.18%] mt-[49.28%] relative size-[22.993px]">
                      <div className="flex-none scale-y-[-100%] size-[22.993px]">
                        <BackgroundImage18>
                          <g id="Clip path group">
                            <path d={svgPaths.p302b0d00} id="path165" stroke="url(#paint0_linear_3_7187)" strokeMiterlimit="10" strokeOpacity="0.08" strokeWidth="1.10267" />
                          </g>
                          <defs>
                            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_7187" x1="12.0489" x2="12.0489" y1="0.552482" y2="23.5451">
                              <stop stopColor="white" />
                              <stop offset="1" stopColor="#00858A" />
                            </linearGradient>
                          </defs>
                    ...
                    <div className="[grid-area:1_/_1] flex h-[22.993px] items-center justify-center ml-[66.18%] mt-[16.15%] relative w-[22.999px]">
                      <div className="flex-none h-[22.993px] scale-y-[-100%] w-[22.999px]">
                        <BackgroundImage18>
                          <g id="Clip path group">
                            <path d={svgPaths.pc522180} id="path167" stroke="url(#paint0_linear_3_7168)" strokeMiterlimit="10" strokeOpacity="0.08" strokeWidth="1.10267" />
                          </g>
                          <defs>
                            <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_7168" x1="12.0507" x2="12.0507" y1="0.551333" y2="23.544">
                              <stop stopColor="white" />
                              <stop offset="1" stopColor="#00858A" />
                            </linearGradient>
                          </defs>
                ...
                <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
                  ...
                  <div className="[grid-area:1_/_1] flex h-[22.993px] items-center justify-center ml-[66.18%] mt-[16.15%] relative w-[22.999px]">
                    <div className="flex-none h-[22.993px] scale-y-[-100%] w-[22.999px]">
                      <BackgroundImage18>
                        <g id="Clip path group">
                          <path d={svgPaths.pc522180} id="path167" stroke="url(#paint0_linear_3_7119)" strokeMiterlimit="10" strokeOpacity="0.08" strokeWidth="1.10267" />
                        </g>
                        <defs>
                          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_7119" x1="12.0507" x2="12.0507" y1="0.551333" y2="23.544">
                            <stop stopColor="white" />
                            <stop offset="1" stopColor="#00858A" />
                          </linearGradient>
                        </defs>
                ...
                <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid place-items-start relative shrink-0">
                  ...
                  <div className="[grid-area:1_/_1] flex items-center justify-center ml-[0.01%] mt-[50.04%] relative size-[22.987px]">
                    <div className="flex-none scale-y-[-100%] size-[22.987px]">
                      <BackgroundImage18>
                        <g id="Clip path group">
                          <path d={svgPaths.p332fae00} id="path155" stroke="url(#paint0_linear_3_7065)" strokeMiterlimit="10" strokeOpacity="0.08" strokeWidth="1.10267" />
                        </g>
                        <defs>
                          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_7065" x1="12.0447" x2="12.0447" y1="0.551333" y2="23.5379">
                            <stop stopColor="white" />
                            <stop offset="1" stopColor="#00858A" />
                          </linearGradient>
                        </defs>
                  ...
                  <div className="[grid-area:1_/_1] flex items-center justify-center ml-[16.91%] mt-[66.18%] relative size-[22.993px]">
                    <div className="flex-none scale-y-[-100%] size-[22.993px]">
                      <BackgroundImage18>
                        <g id="Clip path group">
                          <path d={svgPaths.p15f39c00} id="path157" stroke="url(#paint0_linear_3_7095)" strokeMiterlimit="10" strokeOpacity="0.08" strokeWidth="1.10267" />
                        </g>
                        <defs>
                          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_3_7095" x1="12.0489" x2="12.0489" y1="0.551596" y2="23.5442">
                            <stop stopColor="white" />
                            <stop offset="1" stopColor="#00858A" />
                          </linearGradient>
                        </defs>
              ...
              <div className="content-stretch flex h-[43px] items-center justify-center relative shrink-0 w-[36px]" data-name="Logo Klik">
                <div className="relative shrink-0 size-[40px]" data-name="image 296">
                  <div className="absolute inset-0 overflow-hidden pointer-events-none">
                    <img alt="" className="absolute h-[300%] left-[-238.9%] max-w-none top-[-91.17%] w-[841.96%]" src={imgImage296} />
                  </div>
                </div>
              </div>
              <div className="basis-0 content-stretch flex flex-col grow items-start justify-between min-h-px min-w-px relative shrink-0">
                <div className="content-stretch flex flex-col items-start relative shrink-0">
                  <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0">
                    <div className="content-stretch flex items-center p-[8px] relative shrink-0" data-name="Dashboard KPI">
                      <BackgroundImage24>
                        <g id="home">
                          <path d={svgPaths.p1e61f00} fill="var(--fill-0, white)" id="Vector" />
                        </g>
                      </BackgroundImage24>
                    </div>
                    <div className="content-stretch flex items-center p-[8px] relative shrink-0" data-name="Onboarding Mini">
                      <BackgroundImage24>
                        <g id="material-symbols:developer-guide">
                          <path d={svgPaths.pa7f0680} fill="var(--fill-0, white)" id="Vector" />
                        </g>
                      </BackgroundImage24>
                    </div>
                    <div className="content-stretch flex items-center p-[8px] relative shrink-0" data-name="Settings Mini">
                      <BackgroundImage24>
                        <g id="settings">
                          <path d={svgPaths.p17956500} fill="var(--fill-0, white)" id="Vector" />
                        </g>
                      </BackgroundImage24>
                    </div>
                    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0">
                      <div className="content-stretch flex flex-col items-start px-0 py-[10px] relative shrink-0 w-[36px]">
                        <div className="h-0 relative shrink-0 w-[36px]" data-name="Divider">
                          <div className="absolute inset-[-0.5px_0]">
                            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 36 1">
                              <g id="Divider">
                                <path d="M0 0.5H36" id="line" stroke="var(--stroke-0, #00858A)" />
                              </g>
                            </svg>
                          </div>
                        </div>
                      ...
                      <BackgroundImage19>
                        <BackgroundImage24>
                          <g id="assignment-ind">
                            <path d={svgPaths.p2e2af300} fill="var(--fill-0, white)" id="Vector" />
                          </g>
                        </BackgroundImage24>
                      </BackgroundImage19>
                      <BackgroundImage19>
                        <BackgroundImage24>
                          <g id="school">
                            <path d={svgPaths.pc397f80} fill="var(--fill-0, white)" id="Vector" />
                          </g>
                        </BackgroundImage24>
                      </BackgroundImage19>
                    </div>
                ...
                <div className="content-stretch flex flex-col items-start relative shrink-0 w-full">
                  <div className="content-stretch flex flex-col h-[42px] items-start justify-center relative shrink-0 w-full">
                    <div className="content-stretch flex items-center p-[2px] relative rounded-[8px] shrink-0" data-name="Profil Pekerja Mini">
                      <div className="bg-[#c1c7cd] content-stretch flex gap-[10px] items-center justify-center relative rounded-[9999px] shrink-0 size-[32px]" data-name="Avatar">
                        ...
                        <BackgroundImage25 additionalClassNames="absolute bottom-[-4px] right-[-4px]">
                          <g id="sme icon">
        ...
        <div className="basis-0 content-stretch flex flex-col grow h-full items-start min-h-px min-w-px overflow-clip relative shrink-0">
          <div className="bg-[#006573] shrink-0 sticky top-0 w-full" data-name="Header">
            <div className="flex flex-row items-center justify-end overflow-clip rounded-[inherit] size-full">
              <div className="content-stretch flex items-center justify-end px-[16px] py-[12px] relative w-full">
                <div className="basis-0 content-stretch flex gap-[16px] grow items-center min-h-px min-w-px overflow-clip relative shrink-0" data-name="navbar top">
                  <div className="basis-0 bg-[#00495d] grow min-h-px min-w-px relative rounded-[8px] shrink-0">
                    <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
                      <div className="content-stretch flex gap-[8px] items-center px-[16px] py-[8px] relative w-full">
                        ...
                        <p className="font-['IBM_Plex_Sans:Medium',sans-serif] leading-[24px] not-italic relative shrink-0 text-[16px] text-nowrap text-white whitespace-pre">Search</p>
                      </div>
                    </div>
                  </div>
                  <div className="content-stretch flex gap-[16px] items-center relative shrink-0">
                    <div className="bg-[#00495d] content-stretch flex flex-col items-center justify-center p-[8px] relative rounded-[8px] shrink-0 size-[40px]">
                      <BackgroundImage22>
                        <g id="dashboard">
          ...
          <div className="basis-0 bg-white content-stretch flex flex-col grow items-start min-h-px min-w-px overflow-x-clip overflow-y-auto relative rounded-tl-[24px] shrink-0 w-full">
            <div className="bg-white h-[960px] relative rounded-tl-[24px] shrink-0 w-full">
              <div className="flex flex-col items-end justify-center overflow-clip rounded-[inherit] size-full">
                <div className="content-stretch flex flex-col gap-[24px] items-end justify-center p-[24px] relative size-full">
                  <div className="basis-0 content-stretch flex gap-[24px] grow items-center min-h-px min-w-px relative shrink-0 w-full">
                    <div className="basis-0 grow h-full min-h-px min-w-px relative rounded-[24px] shrink-0" data-name="Injourney Banner">
                      <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[24px] size-full" src={imgInjourneyBanner} />
                      <div className="flex flex-col items-center justify-end overflow-clip rounded-[inherit] size-full">
                        <div className="content-stretch flex flex-col gap-[10px] items-center justify-end p-[24px] relative size-full">
                          <div className="content-stretch flex gap-[24px] items-start justify-center relative shrink-0 w-full">
                            <div className="bg-[rgba(0,0,0,0)] content-stretch flex items-start overflow-clip relative rounded-[12px] self-stretch shrink-0">
                              <div className="bg-[rgba(26,26,26,0.4)] overflow-clip relative rounded-[12px] shrink-0 size-[62px]">
                                <div className="absolute left-1/2 size-[24px] top-1/2 translate-x-[-50%] translate-y-[-50%]" data-name="arrow-back">
                                  <BackgroundImage11 />
                                </div>
                              </div>
                            </div>
                            <div className="basis-0 bg-[rgba(26,26,26,0.4)] grow min-h-px min-w-px relative rounded-[16px] shrink-0">
                              <div className="flex flex-row items-center size-full">
                                <div className="content-stretch flex items-center p-[16px] relative w-full">
                                  <p className="[white-space-collapse:collapse] basis-0 font-['Inter:Semi_Bold',sans-serif] font-semibold grow leading-[30px] min-h-px min-w-px not-italic overflow-ellipsis overflow-hidden relative shrink-0 text-[#fdfdfd] text-[20px] text-nowrap">Injourney Employee Exclusive Membership</p>
                                </div>
                              </div>
                            </div>
                            <div className="bg-[rgba(0,0,0,0)] content-stretch flex items-start overflow-clip relative rounded-[12px] self-stretch shrink-0">
                        ...
                        <div className="basis-0 content-stretch flex flex-col grow items-center justify-between min-h-px min-w-px p-[24px] relative shrink-0" data-name="Container">
                          <div className="content-stretch flex flex-col gap-[24px] items-center relative shrink-0">
                                ...
                                <div className="content-stretch flex items-start overflow-clip p-[4px] relative rounded-[inherit] size-full">
                                  <div className="basis-0 bg-gradient-to-b from-[#00858a] grow h-[104px] min-h-px min-w-px relative rounded-[1.67772e+07px] shrink-0 to-[#006573]" data-name="Text">
                                    <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center relative size-full">
                                      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[45px] not-italic relative shrink-0 text-[30px] text-nowrap text-white whitespace-pre">DS</p>
                                    </div>
                                  </div>
                                </div>
                            ...
                            <div className="content-stretch flex flex-col gap-[8px] items-center justify-center relative shrink-0 w-[223px]" data-name="Container">
                              <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[32px] min-w-full not-italic relative shrink-0 text-[#181d27] text-[24px] text-center w-[min-content]">Dimas Sayyid</p>
                            ...
                            <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-[223px]" data-name="Container">
                              <ContainerBackgroundImage>
                                <BackgroundImage31 additionalClassNames="bg-[rgba(0,133,138,0.1)] size-[32px]">
                                  <BackgroundImage25 additionalClassNames="relative shrink-0">
                                ...
                                <ContainerBackgroundImage1 additionalClassNames="h-[33px] w-[151.266px]">
                                  ...
                                  <TextBackgroundImageAndText text="VP Human Capital Strategy" additionalClassNames="w-full" />
                                </ContainerBackgroundImage1>
                              </ContainerBackgroundImage>
                              <ContainerBackgroundImage>
                                <BackgroundImage31 additionalClassNames="bg-[rgba(49,198,177,0.2)] size-[32px]">
                                  <BackgroundImage16 additionalClassNames="relative shrink-0 size-[16px]">
                                ...
                                <div className="h-[33px] relative shrink-0" data-name="Container">
                                  <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col h-full items-start relative">
                                    ...
                                    <TextBackgroundImageAndText text="dimas.sayyid@injourney.id" additionalClassNames="overflow-clip w-[151.266px]" />
                                  </div>
                                </div>
                              </ContainerBackgroundImage>
                              <ContainerBackgroundImage>
                                ...
                                <ContainerBackgroundImage1 additionalClassNames="h-[49.5px] w-[151.266px]">
                                  ...
                                  <TextBackgroundImageAndText text="Herdy Harman" additionalClassNames="w-full" />
                                  <BackgroundImageAndText3 text="Director of HR and Digital" />
                                </ContainerBackgroundImage1>
                              </ContainerBackgroundImage>
                              <ContainerBackgroundImage>
                                <BackgroundImage31 additionalClassNames="bg-[rgba(0,101,115,0.1)] size-[32px]">
                                  <BackgroundImage16 additionalClassNames="relative shrink-0 size-[16px]">
                                ...
                                <ContainerBackgroundImage1 additionalClassNames="h-[49.5px] w-[143.266px]">
                                  ...
                                  <TextBackgroundImageAndText text="Direktorat Human Capital" additionalClassNames="w-full" />
                                  <BackgroundImageAndText3 text="InJourney Holding" />
                                </ContainerBackgroundImage1>
                              </ContainerBackgroundImage>
                            </div>
                          </div>
                          <div className="bg-white content-stretch flex gap-[16px] items-center px-[29px] py-[8px] relative rounded-[6px] shrink-0" data-name="Button">
                            <div aria-hidden="true" className="absolute border border-[#d5d7da] border-solid inset-0 pointer-events-none rounded-[6px]" />
                  ...
                  <div className="content-stretch flex gap-[24px] items-center relative shrink-0 w-full" data-name="Container">
                    <CardBackgroundImage>
                      <div className="relative shrink-0 w-full" data-name="WelcomeBanner">
                        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[24px] items-start relative w-full">
                          <BackgroundImage31 additionalClassNames="bg-[rgba(223,253,234,0.4)] size-[40px]">
                            <BackgroundImage24>
                              <g clipPath="url(#clip0_3_6967)" id="Icon">
                          ...
                          <div className="basis-0 grow min-h-px min-w-px relative shrink-0" data-name="Container">
                            <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[4px] items-start relative w-full">
                              ...
                              <HeadingBackgroundImageAndText text="VIA (Virtual Injourney Assistant) Tersedia!" />
                    ...
                    <CardBackgroundImage>
                      <WelcomeBannerBackgroundImage>
                        <BackgroundImage31 additionalClassNames="bg-[rgba(223,253,234,0.4)] size-[40px]">
                          <BackgroundImage24>
                            <g clipPath="url(#clip0_3_6957)" id="Icon">
                    ...
                    <div className="flex flex-col justify-center overflow-clip rounded-[inherit] size-full">
                      <div className="content-stretch flex flex-col gap-[48px] items-start justify-center p-[48px] relative w-full">
                        ...
                        <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full">
                          <div className="content-stretch flex gap-[24px] items-center relative shrink-0 w-full">
                            <div className="flex flex-row items-center self-stretch">
                              <div className="bg-white content-stretch flex gap-[24px] h-full items-start overflow-clip p-[24px] relative rounded-[16px] shadow-[0px_4px_8px_-2px_rgba(10,13,18,0.1),0px_2px_4px_-2px_rgba(10,13,18,0.06)] shrink-0" data-name="Employee Card HBD">
                                ...
                                <BackgroundImage12 text="Dimas Sayyid Mahfuzh" text1="Group Head Human Capital Strategy" text2="Head Office" />
                              </div>
                            </div>
                            <div className="flex flex-row items-center self-stretch">
                              <div className="bg-white content-stretch flex gap-[24px] h-full items-start overflow-clip p-[24px] relative rounded-[16px] shadow-[0px_4px_8px_-2px_rgba(10,13,18,0.1),0px_2px_4px_-2px_rgba(10,13,18,0.06)] shrink-0" data-name="Employee Card HBD">
                                ...
                                <BackgroundImage12 text="Binavia Wardhani" text1="HC Strategy Senior Officer" text2="Head Office" />
                              </div>
                            </div>
                            <div className="flex flex-row items-center self-stretch">
                              <div className="bg-white content-stretch flex gap-[24px] h-full items-center overflow-clip p-[24px] relative rounded-[16px] shadow-[0px_4px_8px_-2px_rgba(10,13,18,0.1),0px_2px_4px_-2px_rgba(10,13,18,0.06)] shrink-0" data-name="Employee Card HBD">
                                <BackgroundImage13 />
                                <BackgroundImage12 text="Agung Triatmodjo" text1="CCTV Senior Operator" text2="Kantor Cabang Bandara Soekarno-Hatta" />
                              </div>
                            </div>
                          ...
                          <div className="flex h-[10px] items-center justify-center relative shrink-0 w-full" style={{ "--transform-inner-width": "0", "--transform-inner-height": "0" } as React.CSSProperties}>
                            <div className="flex-none rotate-[270deg] w-full">
                              <div className="bg-[rgba(242,244,248,0.4)] h-[1228px] overflow-clip relative rounded-[8px] w-full" data-name="Scroll">
                                <div className="absolute bg-white h-[50px] left-0 rounded-[8px] top-0 w-[10px]" />
                              </div>
                            </div>
                          </div>
                        </div>
            ...
            <div className="bg-white relative shrink-0 w-full" data-name="QuickAccessModules">
              <div className="size-full">
                <div className="content-stretch flex flex-col gap-[24px] items-start px-[24px] py-[48px] relative w-full">
                  <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Container">
                    <div className="h-[24px] relative shrink-0 w-[162.867px]" data-name="Heading 3">
                      <div className="bg-clip-padding border-0 border-[transparent] border-solid relative size-full">
                        <p className="absolute font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[30px] left-0 not-italic text-[#414651] text-[20px] text-nowrap top-[-1px] whitespace-pre">Rinjani ITMS Features</p>
                      </div>
                    </div>
                    <div className="h-[22px] relative rounded-[6px] shrink-0 w-[101.414px]" data-name="Badge">
                      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex items-center justify-center overflow-clip px-[9px] py-[3px] relative rounded-[inherit] size-full">
                        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[16px] not-italic relative shrink-0 text-[#414651] text-[12px] text-nowrap whitespace-pre">Stage 1 - 2026</p>
                      </div>
                      <div aria-hidden="true" className="absolute border border-[#d5d7da] border-solid inset-0 pointer-events-none rounded-[6px]" />
                    </div>
                  </div>
                        ...
                        <div className="relative shrink-0 w-full">
                          <div className="content-stretch flex items-start overflow-clip relative rounded-[inherit] w-full">
                            <div className="basis-0 bg-white grow min-h-px min-w-px relative shrink-0" data-name="Tab">
                              <BackgroundImage23>
                                <IconTabBackgroundImage>
                                  <circle cx="24" cy="24" fill="var(--fill-0, #00A199)" id="background" r="24" />
                                  <g id="emoji-events">
                                    <path d={svgPaths.p9281500} fill="var(--fill-0, white)" id="Vector" />
                                  </g>
                                </IconTabBackgroundImage>
                                <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0" data-name="text">
                                  <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[24px] not-italic relative shrink-0 text-[#121619] text-[16px] w-full">Perfomance</p>
                                </div>
                              </BackgroundImage23>
                              <div aria-hidden="true" className="absolute border-[#00a199] border-[0px_0px_3px] border-solid inset-0 pointer-events-none shadow-[0px_2px_4px_0px_rgba(217,217,217,0.2)]" />
                            </div>
                            <TabBackgroundImage>
                              <IconTabBackgroundImage>
                                <circle cx="24" cy="24" fill="var(--fill-0, #F2F4F8)" id="background" r="24" />
                                <g id="assignment-ind">
                                  <path d={svgPaths.p2ef35500} fill="var(--fill-0, #878D96)" id="Vector" />
                                </g>
                              </IconTabBackgroundImage>
                              <TextBackgroundImageAndText2 text="Talent" />
                            </TabBackgroundImage>
                            <TabBackgroundImage>
                              <IconTabBackgroundImage>
                                <circle cx="24" cy="24" fill="var(--fill-0, #F2F4F8)" id="background" r="24" />
                                <g id="school">
                                  <path d={svgPaths.p3bed7600} fill="var(--fill-0, #878D96)" id="Vector" />
                                </g>
                              </IconTabBackgroundImage>
                              <TextBackgroundImageAndText2 text="Education" />
                            </TabBackgroundImage>
                          </div>
                                ...
                                <BackgroundImage21>
                                  <BackgroundImage33>
                                    <div className="content-stretch flex h-[40px] items-start justify-between relative shrink-0 w-full" data-name="Container">
                                      <BackgroundImage31 additionalClassNames="bg-[rgba(254,154,0,0.1)] size-[40px]">
                                        <BackgroundImage24>
                                          <g clipPath="url(#clip0_3_6934)" id="Icon">
                                            <path d={svgPaths.p14d24500} id="Vector" stroke="var(--stroke-0, #BB4D00)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
                                            <path d={svgPaths.p240d7000} id="Vector_2" stroke="var(--stroke-0, #BB4D00)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
                                            <path d={svgPaths.p25499600} id="Vector_3" stroke="var(--stroke-0, #BB4D00)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
                                          </g>
                                          <defs>
                                            <clipPath id="clip0_3_6934">
                                              <rect fill="white" height="20" width="20" />
                                            </clipPath>
                                          </defs>
                                        </BackgroundImage24>
                                      </BackgroundImage31>
                                      <BadgeBackgroundImageAndText1 text="5 pending check-in" additionalClassNames="w-[110.023px]" />
                                    </div>
                                    <div className="content-stretch flex flex-col gap-[4px] h-[52px] items-start relative shrink-0 w-full" data-name="Container">
                                      <HeadingBackgroundImageAndText1 text="Goal-Setting KPI Dashboard" />
                                      <BackgroundImage29>{`Perencanaan & Monitoring KPI`}</BackgroundImage29>
                                    </div>
                                    <ParagraphBackgroundImageAndText1 text="Update progress KPI individual dan monitoring pencapaian target" />
                                  </BackgroundImage33>
                                </BackgroundImage21>
                              </div>
                              {[...Array(2).keys()].map((_, i) => (
                                <CardBackgroundImage1 additionalClassNames="self-stretch">
                                  <BackgroundImage33>
                                    <div className="content-stretch flex h-[40px] items-start justify-between relative shrink-0 w-full" data-name="Container">
                                      <BackgroundImage31 additionalClassNames="bg-[rgba(254,154,0,0.1)] size-[40px]">
                                        <IconBackgroundImage3>
                                          <path d={svgPaths.p3ac0b600} id="Vector" stroke="var(--stroke-0, #BB4D00)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
                                          <path d={svgPaths.p3c797180} id="Vector_2" stroke="var(--stroke-0, #BB4D00)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
                                        </IconBackgroundImage3>
                                      </BackgroundImage31>
                                      <BadgeBackgroundImageAndText1 text="Updated 2 hari lalu" additionalClassNames="w-[107.859px]" />
                                    </div>
                                    <div className="content-stretch flex flex-col gap-[4px] h-[52px] items-start relative shrink-0 w-full" data-name="Container">
                                      <HeadingBackgroundImageAndText1 text="KPI Tree (Basic Alignment)" />
                                      <ParagraphBackgroundImageAndText2 text="Cascading KPI Organisasi" />
                                    </div>
                                    <ParagraphBackgroundImageAndText1 text="Visualisasi alignment KPI korporat hingga individual" />
                                  </BackgroundImage33>
                                </CardBackgroundImage1>
                              ))}
                              <CardBackgroundImage1 additionalClassNames="h-[135px] opacity-0">
                                <div className="basis-0 grow min-h-px min-w-px relative shrink-0 w-full" data-name="QuickAccessModules">
                                  <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[12px] items-start relative size-full">
                                    <div className="content-stretch flex h-[40px] items-start justify-between relative shrink-0 w-full" data-name="Container">
                                      <BackgroundImage31 additionalClassNames="bg-[rgba(254,154,0,0.1)] size-[40px]">
                                        <IconBackgroundImage3>
                                          <path d="M10 5.83333V17.5" id="Vector" stroke="var(--stroke-0, #BB4D00)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
                                          <path d={svgPaths.p25713000} id="Vector_2" stroke="var(--stroke-0, #BB4D00)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.66667" />
                                        </IconBackgroundImage3>
                                      </BackgroundImage31>
                                      <BadgeBackgroundImageAndText1 text="450+ KPI tersedia" additionalClassNames="w-[103.75px]" />
                                    </div>
                                    <div className="content-stretch flex flex-col gap-[4px] h-[52px] items-start relative shrink-0 w-full" data-name="Container">
                                      <HeadingBackgroundImageAndText1 text="KPI Dictionary" />
                                      <ParagraphBackgroundImageAndText2 text="Katalog Standar KPI" />
                                    </div>
                                    <ParagraphBackgroundImageAndText1 text="Definisi standar KPI, formula perhitungan, dan benchmark" additionalClassNames="justify-center" />
                                  </div>
                                </div>
                              </CardBackgroundImage1>
                            </div>
                  ...
                  <div className="gap-[24px] grid grid-cols-[repeat(4,_minmax(0px,_1fr))] grid-rows-[repeat(1,_minmax(0px,_1fr))] h-[401px] relative shrink-0 w-full" data-name="PerformanceCards">
                    ...
                    <div className="[grid-area:1_/_2] bg-gradient-to-b from-[#31c6b1] place-self-stretch relative rounded-[16px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] shrink-0 to-[#5ae2c3]" data-name="Card">
                      <BackgroundImage35>
                        ...
                        <button 
                          className="relative rounded-[6px] shrink-0 cursor-pointer transition-opacity hover:opacity-90" 
                          data-name="Button"
                          onClick={() => setIsEQSModalOpen(true)}
                        >
                    ...
                    <div className="[grid-area:1_/_4] place-self-stretch relative rounded-[16px] shadow-[0px_10px_15px_-3px_rgba(0,0,0,0.1),0px_4px_6px_-4px_rgba(0,0,0,0.1)] shrink-0" data-name="Card" style={{ backgroundImage: "linear-gradient(127.974deg, rgb(240, 68, 56) 0%, rgb(231, 0, 11) 100%)" }}>
                      <BackgroundImage35 additionalClassNames="overflow-clip rounded-[inherit]">
                      ...
                      <div className="basis-0 content-stretch flex grow items-center justify-center min-h-px min-w-px relative shrink-0 w-full">
                        <div className="basis-0 content-stretch flex flex-col gap-[24px] grow h-full items-start min-h-px min-w-px relative shrink-0">
                          <div className="basis-0 content-stretch flex gap-[24px] grow items-start min-h-px min-w-px relative shrink-0 w-full">
                            <BackgroundImage14 text="Talenta Belum Optimal" text1="(" text2="Sleeping Tiger" text3=")" />
                            <BackgroundImage15 text="Talenta Berbakat" text1="(Promotable)" />
                          ...
                          <div className="basis-0 content-stretch flex gap-[24px] grow items-start min-h-px min-w-px relative shrink-0 w-full">
                            <BackgroundImage14 text="Talenta Belum Optimal" text1="(" text2="Sleeping Tiger" text3=")" />
                            <BackgroundImage15 text="Talenta Berbakat" text1="(Promotable)" />
                            <BackgroundImage14 text="Talenta Berbakat" text1="(" text2="Promotable" text3=")" />
                          </div>
                          <div className="basis-0 content-stretch flex gap-[24px] grow items-start min-h-px min-w-px relative shrink-0 w-full">
                            <BackgroundImage14 text="Talenta yang Tidak Sesuai" text1="(" text2="Unfit" text3=")" />
                            <BackgroundImage14 text="Talenta Penyokong" text1="(" text2="Solid Contributor" text3=")" />
                            <BackgroundImage15 text="Talenta Penyokong" text1="(Solid Contributor)" />
                          </div>
                        </div>
                      </div>
                    </SpiderwebDiagramBackgroundImage>
            ...
            <ExternalSystemsBackgroundImage>
              ...
              <div className="content-stretch flex gap-[24px] items-start relative shrink-0 w-full" data-name="Container">
                <BackgroundImage20>
                  <BackgroundImage33>
                    ...
                    <div className="content-stretch flex flex-col gap-[4px] h-[44.5px] items-start relative shrink-0 w-full" data-name="Container">
                      <BackgroundImage30>{`SAP HCM & Employee Central (Core HCM)`}</BackgroundImage30>
                ...
                <BackgroundImage20>
                  <BackgroundImage33>
                    <div className="content-stretch flex h-[40px] items-start justify-between relative shrink-0 w-full" data-name="Container">
                      <BackgroundImage31 additionalClassNames="bg-[#f8f9fc] size-[40px]">
                        <BackgroundImage24>
                          <g id="person">
                ...
                <BackgroundImage20>
                  <BackgroundImage33>
                    <div className="content-stretch flex h-[40px] items-start justify-between relative shrink-0 w-full" data-name="Container">
                      <BackgroundImage31 additionalClassNames="bg-sky-50 size-[40px]">
                        <BackgroundImage24>
                          <g id="flight">
                ...
                <BackgroundImage34>
                    ...
                    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full" data-name="Container">
                      <CardBackgroundImage2>
                        <AnnouncementsSectionBackgroundImage>
                          <BackgroundImage31 additionalClassNames="bg-[rgba(0,133,138,0.1)] size-[40px]">
                            <BackgroundImage24>
                      ...
                      <CardBackgroundImage2>
                        <AnnouncementsSectionBackgroundImage>
                          <BackgroundImage31 additionalClassNames="bg-[rgba(0,101,115,0.1)] size-[40px]">
                            <IconBackgroundImage3>
                  ...
                  <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full" data-name="Container">
                    ...
                    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full" data-name="Container">
                      <CardBackgroundImage2>
                        <AnnouncementsSectionBackgroundImage>
                          <BackgroundImage31 additionalClassNames="bg-[rgba(90,226,195,0.2)] size-[40px]">
                            <IconBackgroundImage3>
                      ...
                      <CardBackgroundImage2>
                        <AnnouncementsSectionBackgroundImage>
                          ...
                          <BackgroundImage28>
                            ...
                            <div className="absolute content-stretch flex flex-col gap-[4px] h-[46px] items-start left-0 top-[27.33px] w-[1142px]" data-name="Container">
                              <HeadingBackgroundImageAndText1 text="Introducing VIA - Virtual Injourney Assistant untuk HR Support 24/7" />
                              <ParagraphBackgroundImageAndText5 text="Tanyakan apa saja tentang HC policy, KPI definitions, talent info, atau learning programs. VIA powered by RAG AI siap membantu Anda kapan saja!" />
                            </div>
                        ...
                        <AnnouncementsSectionBackgroundImage>
                          ...
                          <BackgroundImage28>
                            ...
                            <div className="absolute content-stretch flex flex-col gap-[4px] h-[46px] items-start left-0 top-[27.33px] w-[1142px]" data-name="Container">
                              ...
                              <BackgroundImage27>{`Evaluasi program pelatihan (Reaction & Learning) kini dapat disubmit langsung setelah course completion. Hasil evaluasi membantu kami improve kualitas program.`}</BackgroundImage27>
                            </div>
      ...
      <div className="absolute bottom-[40px] content-stretch flex flex-col items-end justify-center right-[40px]" data-name="ChatWidget">
        <div className="content-stretch flex items-center justify-center relative rounded-[1.67772e+07px] shadow-[0px_25px_50px_-12px_rgba(0,0,0,0.25)] shrink-0 size-[56px]" data-name="Button">
          <img alt="" className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none rounded-[1.67772e+07px] size-full" src={imgButton} />
          <BackgroundImage22>
            <g id="chat">
              <path d={svgPaths.p114ea00} fill="var(--fill-0, white)" id="Vector" />
            </g>
          </BackgroundImage22>
        </div>
      </div>
      ...
      {/* EQS Detail Modal */}
      <EQSDetailModal
        isOpen={isEQSModalOpen}
        onClose={() => setIsEQSModalOpen(false)}
        data={{
          totalScore: 85.83,
          period: 'Q4 2025',
          kinerja: 85,
