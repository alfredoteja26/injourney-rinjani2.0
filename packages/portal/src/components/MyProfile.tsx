    ...
    switch (activeSection) {
      ...
      case "riwayat-kesehatan":
        return (
          <div className="p-4 w-full flex flex-col gap-6">
            <Wrapper3>
              <SectionHeader title="Riwayat Kesehatan" subtitle="Informasi kesehatan dan medical check-up" />
              
              {/* Medical Check-up History */}
              <div className="flex flex-col gap-4 w-full mb-6">
                <div className="flex items-center gap-2 mb-2">
                  <Heart className="w-5 h-5" style={{ color: 'var(--primary)' }} />
                  <h3 className="font-semibold" style={{ color: 'var(--foreground)' }}>Medical Check-Up Terakhir</h3>
                </div>
                
                <div className="bg-card border border-border rounded-lg p-4">
                  <div className="grid grid-cols-2 gap-4">
                    <InfoGroup label="Tanggal Pemeriksaan" value="15 Desember 2025" tier={1} />
                    <InfoGroup label="Rumah Sakit" value="RS Mitra Keluarga Kelapa Gading" tier={1} />
                    <InfoGroup label="Tekanan Darah" value="120/80 mmHg" tier={1} />
                    <InfoGroup label="Golongan Darah" value="O" tier={1} />
                    <InfoGroup label="Berat Badan" value="68 kg" tier={1} />
                    <InfoGroup label="Tinggi Badan" value="170 cm" tier={1} />
                    <InfoGroup label="BMI" value="23.5 (Normal)" tier={1} />
                    <InfoGroup label="Status Kesehatan" value="Sehat" tier={1} />
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-4 w-full mb-6">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className="font-semibold" style={{ color: 'var(--foreground)' }}>Asuransi Kesehatan</h3>
                </div>
                
                <div className="bg-card border border-border rounded-lg p-4">
                  <div className="grid grid-cols-2 gap-4">
                    <InfoGroup label="Penyedia" value="BPJS Kesehatan" tier={1} />
                    <InfoGroup label="Nomor Kartu" value="0001234567890" tier={1} />
                    <InfoGroup label="Kelas Perawatan" value="Kelas 1" tier={1} />
                    <InfoGroup label="Status" value="Aktif" tier={1} />
                  </div>
                  
                  <div className="border-t border-border my-4"></div>
                  
                  <div className="grid grid-cols-2 gap-4">
                    <InfoGroup label="Asuransi Tambahan" value="Allianz Healthcare" tier={1} />
                    <InfoGroup label="Nomor Polis" value="ALZ-2024-HC-001234" tier={1} />
                    <InfoGroup label="Masa Berlaku" value="01 Jan 2024 - 31 Des 2026" tier={1} />
                    <InfoGroup label="Coverage" value="Rawat Inap, Rawat Jalan, Gigi" tier={1} />
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-4 w-full">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className="font-semibold" style={{ color: 'var(--foreground)' }}>Riwayat Vaksinasi</h3>
                </div>
                
                <ItemCard title="COVID-19 Booster Dose 2" subtitle="Moderna" date="20 Agustus 2024" tier={1}>
                  <div className="grid grid-cols-2 gap-4">
                    <InfoGroup label="Lokasi" value="RS Siloam Semanggi" tier={3} />
                    <InfoGroup label="Batch Number" value="MOD-2024-B2-12345" tier={3} />
                  </div>
                </ItemCard>

                <ItemCard title="COVID-19 Booster Dose 1" subtitle="Pfizer" date="15 Januari 2024" tier={1}>
                  <div className="grid grid-cols-2 gap-4">
                    <InfoGroup label="Lokasi" value="Puskesmas Kelapa Gading" tier={3} />
                    <InfoGroup label="Batch Number" value="PFZ-2024-B1-67890" tier={3} />
                  </div>
                </ItemCard>

                <ItemCard title="COVID-19 Dose 2" subtitle="Sinovac" date="10 Agustus 2023" tier={1}>
                  <div className="grid grid-cols-2 gap-4">
                    <InfoGroup label="Lokasi" value="Senayan Vaccination Center" tier={3} />
                    <InfoGroup label="Batch Number" value="SNV-2023-D2-11111" tier={3} />
                  </div>
                </ItemCard>

                <ItemCard title="COVID-19 Dose 1" subtitle="Sinovac" date="10 Juli 2023" tier={1}>
                  <div className="grid grid-cols-2 gap-4">
                    <InfoGroup label="Lokasi" value="Senayan Vaccination Center" tier={3} />
                    <InfoGroup label="Batch Number" value="SNV-2023-D1-22222" tier={3} />
                  </div>
                </ItemCard>
              </div>
            </Wrapper3>
              ...
              <div className="content-stretch flex flex-col items-start overflow-clip relative rounded-[inherit] w-full h-full">
                ...
                <div className="relative shrink-0 w-full flex-1 overflow-hidden">
                  <Wrapper3 additionalClassNames="overflow-x-clip overflow-y-auto h-full">
                    ...
                    />
                    <SidebarItem
                      icon={<Heart size={18} style={{ color: activeSection === "riwayat-kesehatan" ? "var(--primary)" : "var(--muted-foreground)" }} />}
                      label="RIWAYAT KESEHATAN"
                      isActive={activeSection === "riwayat-kesehatan"}
                      onClick={() => setActiveSection("riwayat-kesehatan")}
                    />
                  </Wrapper3>
                </div>
              </div>
                    ...
                    <div className="content-stretch flex gap-[16px] items-center p-[16px] relative w-full">
                      ...
                      <div className="basis-0 content-stretch flex flex-col gap-[8px] grow items-start min-h-px min-w-px not-italic relative shrink-0 text-foreground text-nowrap">
                        <p className="font-['Inter'] font-semibold leading-[28px] relative shrink-0 text-[20px]">
                          ...
                          {activeSection === "riwayat-kesehatan" && "Riwayat Kesehatan"}
                        </p>
