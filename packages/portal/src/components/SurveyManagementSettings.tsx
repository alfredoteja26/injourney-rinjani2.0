...
export function SurveyManagementSettings({ 
  ...
  const [activeSubTab, setActiveSubTab] = useState<"surveys" | "components">("surveys");
  ...
  const [surveys, setSurveys] = useState<Survey[]>([
    {
      ...
      isMandatory: true,
      mandatoryStartDate: "2026-01-01",
      mandatoryEndDate: "2026-01-31"
    },
    {
      id: "1",
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      ...
      <div style={{ 
        ...
        <button
          ...
          style={{
            padding: '8px 16px',
            borderBottom: activeSubTab === "surveys" ? '2px solid var(--primary)' : '2px solid transparent',
            color: activeSubTab === "surveys" ? 'var(--primary)' : 'var(--muted-foreground)',
            fontWeight: activeSubTab === "surveys" ? 'var(--font-weight-semibold)' : 'var(--font-weight-normal)',
            background: 'none',
            border: 'none',
            cursor: 'pointer',
            transition: 'all 0.2s'
        ...
        <button
          ...
          style={{
            padding: '8px 16px',
            borderBottom: activeSubTab === "components" ? '2px solid var(--primary)' : '2px solid transparent',
            color: activeSubTab === "components" ? 'var(--primary)' : 'var(--muted-foreground)',
            fontWeight: activeSubTab === "components" ? 'var(--font-weight-semibold)' : 'var(--font-weight-normal)',
            background: 'none',
            border: 'none',
            cursor: 'pointer',
            transition: 'all 0.2s'
                  ...
                  <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', gap: '16px' }}>
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: '16px', marginBottom: '12px' }}>
                        ...
                        {survey.isMandatory && survey.mandatoryStartDate && survey.mandatoryEndDate && (
                          <div className="caption" style={{ 
                            ...
                            <Calendar style={{ width: '14px', height: '14px' }} />
                            <span>
                              Mandatory: {new Date(survey.mandatoryStartDate).toLocaleDateString()} - {new Date(survey.mandatoryEndDate).toLocaleDateString()}
                            </span>
                          </div>
                        )}
                        <div className="caption" style={{ display: 'flex', alignItems: 'center', gap: '6px', color: 'var(--muted-foreground)' }}>
