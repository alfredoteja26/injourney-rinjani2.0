...
interface MainSidebarProps {
  ...
  onToggle: () => void;
  onTalentClick: () => void;
  currentPage?: "dashboard" | "talent" | "myprofile" | "settings";
  onProfileClick?: () => void;
  onLogout?: () => void;
...
export function MainSidebar({ isExpanded, onToggle, onTalentClick, currentPage, onProfileClick, onLogout, onSettingsClick, onDashboardClick, userRole, userEmail }: MainSidebarProps) {
