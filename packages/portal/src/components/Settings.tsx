...
import { UserOffboardingPreparation } from "./offboarding/UserOffboardingPreparation";
import { AnnouncementManagement } from "./AnnouncementManagement";
import { MandatorySurveyTestButton } from "./MandatorySurveyTestButton";
...
export default function Settings({ 
  ...
  const [activeTab, setActiveTab] = useState(userRole === "Admin" ? "user-management" : "offboarding");
    ...
    <div style={{ minHeight: '100vh', backgroundColor: 'var(--background)' }}>
      ...
      <div style={{ borderBottom: '1px solid var(--border)', backgroundColor: 'var(--card)' }}>
        ...
        <SettingsTabList>
          ...
          {userRole === "Admin" && (
            <SettingsTab 
              isActive={activeTab === "offboarding"}
      ...
      <div style={{ padding: '24px 32px' }}>
        ...
        {activeTab === "survey" && userRole === "Admin" && (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
            {/* Mandatory Survey Test Button */}
            {userEmail && <MandatorySurveyTestButton userEmail={userEmail} />}
        ...
        {activeTab === "offboarding" && userRole === "Admin" && (
          <div style={{ 
            ...
            <OffboardingManagementNew userRole={userRole} userEmail={userEmail} />
          </div>
        )}

        {activeTab === "offboarding" && userRole === "User" && (
          <div style={{ 
            backgroundColor: 'var(--card)', 
            border: '1px solid var(--border)', 
            borderRadius: 'var(--radius)', 
            ...
            <UserOffboardingPreparation userEmail={userEmail} userName="Current User" />
          </div>
        )}
