  ...
  const employees: Employee[] = [
    {
      ...
      role: "HC Strategy Senior Officer",
                      ...
                      >
                        <div className="flex items-start gap-4">
                          ...
                          <div className="w-12 h-12 rounded-full overflow-hidden shrink-0 bg-muted">
                            <img 
                              src="https://images.unsplash.com/photo-1766066014773-0074bf4911de?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxhc2lhbiUyMHByb2Zlc3Npb25hbCUyMG9mZmljZSUyMHdvcmtlcnxlbnwxfHx8fDE3Njk2NTk4Njh8MA&ixlib=rb-4.1.0&q=80&w=1080" 
                              alt={employee.name}
