...
export function EnhancedSurveyBuilder({ survey, onBack }: SurveyBuilderProps) {
  ...
  // Mandatory Survey Settings
  const [isMandatory, setIsMandatory] = useState(false);
  const [mandatoryStartDate, setMandatoryStartDate] = useState("");
  const [mandatoryEndDate, setMandatoryEndDate] = useState("");
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <div>
                    ...
                    <p style={{
                      ...
                      Users must complete this survey before accessing the platform
                    </p>
                  </div>
                  <Switch
                    checked={isMandatory}
                ...
                {isMandatory && (
                  <div style={{
                    ...
                    <div>
                      <Label htmlFor="mandatoryStartDate">Start Date</Label>
                      <Input
                        id="mandatoryStartDate"
                        type="date"
                        value={mandatoryStartDate}
                        onChange={(e) => setMandatoryStartDate(e.target.value)}
                        className="mt-2"
                        style={{ 
                          border: '1px solid var(--border)',
                          outline: 'none'
                      ...
                      <p style={{
                        ...
                        When survey becomes mandatory
                      </p>
                    </div>
                    <div>
                      <Label htmlFor="mandatoryEndDate">End Date</Label>
                      <Input
                        id="mandatoryEndDate"
                        type="date"
                        value={mandatoryEndDate}
                        onChange={(e) => setMandatoryEndDate(e.target.value)}
                        className="mt-2"
                        style={{ 
                          border: '1px solid var(--border)',
                          outline: 'none'
