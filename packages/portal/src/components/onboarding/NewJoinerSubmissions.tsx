...
import { NewJoinerFormConfig } from "./NewJoinerFormConfig";
import {
  Table,
  TableBody,
  TableCell,
...
interface NewJoinerSubmissionsProps {
  // Remove onFormSettings prop
}

export function NewJoinerSubmissions(props: NewJoinerSubmissionsProps) {
  ...
  return (
    <div>
      ...
      <Dialog open={showSendFormDialog} onOpenChange={setShowSendFormDialog}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              Send the onboarding form link to a new employee via email
            </DialogDescription>
          </DialogHeader>
      ...
      {showFormConfig && (
        <NewJoinerFormConfig 
          onSave={(fields) => {
            console.log('Form configuration saved:', fields);
