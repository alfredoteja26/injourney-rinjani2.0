        ...
        >
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="w-16 h-16 rounded-full overflow-hidden shrink-0 bg-muted">
              <img 
                src="https://images.unsplash.com/photo-1762522921456-cdfe882d36c3?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxwcm9mZXNzaW9uYWwlMjB3b21hbiUyMG9mZmljZSUyMHBvcnRyYWl0fGVufDF8fHx8MTc2OTYxNjYwOHww&ixlib=rb-4.1.0&q=80&w=1080" 
                alt={employee_profile.full_name}
