...
import { Badge, Button, Card, CardContent, CardDescription, CardHeader, CardTitle, Field, FieldDescription, FieldLabel, Select, SelectContent, SelectItem, SelectTrigger, SelectValue, Textarea } from "@rinjani/shared-ui";
...
export function MyKpiChangeRequestsPanel() {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-base">Permohonan perubahan KPI</CardTitle>
        <CardDescription>
          Di luar fase perencanaan — ajukan dengan alasan wajib (DIP-1 §5). Tinjauan atasan/admin disimulasikan dengan tombol demo.
        </CardDescription>
      </CardHeader>
